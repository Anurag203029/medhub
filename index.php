            ...
            <div class="col-md login-left">
                ...
                <form action="validation.php" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" name="user" placeholder="Enter Your User ID" class="form-control" required>
                    </div>
                    <div class="form-group">
                  ...
                  <small><a class="text-decoration-none text-light" href="Signup.php">Click here if you are New</a></small>
                </div>
